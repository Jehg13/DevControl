...
Route::get('/dashboard/actualizaciones/{actualizacion}/editar', [ActualizacionController::class, 'edit'])->name('actualizaciones.edit');
Route::put('/dashboard/actualizaciones/{actualizacion}', [ActualizacionController::class, 'update'])->name('actualizaciones.update');
Route::delete('/dashboard/actualizaciones/{actualizacion}', [ActualizacionController::class, 'destroy'])->name('actualizaciones.destroy');
...
Route::delete('/dashboard/bugs/{bug}', [BugController::class, 'destroy'])->name('bugs.destroy');
Route::get('/dashboard/archivos', function(){ return view('admin.archivos');})->name('archivos');
...
Route::get('/dashboard/incidentes/crear', [IncidenteController::class, 'create'])->name('incidentes.create');
Route::post('/dashboard/incidentes', [IncidenteController::class, 'store'])->name('incidentes.store');
Route::get('/dashboard/incidentes/{incidente}/editar', [IncidenteController::class, 'edit'])->name('incidentes.edit');
Route::put('/dashboard/incidentes/{incidente}', [IncidenteController::class, 'update'])->name('incidentes.update');
Route::delete('/dashboard/incidentes/{incidente}', [IncidenteController::class, 'destroy'])->name('incidentes.destroy');
